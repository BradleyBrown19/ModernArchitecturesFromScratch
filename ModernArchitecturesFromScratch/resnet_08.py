...
__all__ = ['get_runner', 'NestedModel', 'TestMixingGrads', 'AutoConv', 'ConvBatch', 'ConvLayer', 'Identity', 'BaseRes',
           'ResBlock', 'ResNet', 'NestedSequentialModel', 'GetResnet']
...
def GetResnet(size, **kwargs):
    ...
    if size == 18: return ResNet.create(1, [2,2,2,2], **kwargs)
    elif size == 34: return ResNet.create(1, [3,4,6,3], **kwargs)
    elif size == 50: return ResNet.create(4, [3,4,6,3], **kwargs)
    elif size == 150: return ResNet.create(4, [3,4,23,3], **kwargs)
    elif size == 152: return ResNet.create(4, [3,8,36,3], **kwargs)