# AUTOGENERATED! DO NOT EDIT! File to edit: Convolutions and Pooling.ipynb (unless otherwise specified).

__all__ = ['ba3', 'ba3', 'Reshape', 'Flatten', 'get_fan', 'get_gain', 'get_weight', 'Padding', 'convolve', 'conv_back',
           'Conv', 'get_linear_model', 'get_model', 'get_small_datasets', 'train,valid', 'max_pool', 'avg_pool', 'pool',
           'max_back', 'average_back', 'pool_back', 'Pool']

# Cell
from .training_loop_03 import *
ba3 = __import__("ModernArchitecuturesFromScratch.training_loop_03")
