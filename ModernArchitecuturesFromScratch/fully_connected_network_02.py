...
__all__ = ['ba1', 'ba1', 'normalize', 'get_mnist', 'test_near_zero', 'get_stats', 'get_weight', 'linear', 'relu',
           'lin_rel', 'softmax', 'mse_loss', 'Module', 'Linear', 'ReLU', 'CrossSoft', 'Model']

# Cell
from .basic_operations_01 import *
ba1 = __import__("ModernArchitecuturesFromScratch.basic_operations_01")
